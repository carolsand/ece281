...
#define LIGHT_SERVICE_TIMER 1
#define BUMPER_SERVICE_TIMER 2
...
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "BatteryService.h"
// the name of the Init function
...
#if NUM_SERVICES > 2
// the header file with the public fuction prototypes
#define SERV_2_HEADER "LightService.h"
// the name of the Init function
...
// the name of the Init function
#define SERV_3_INIT InitTemplateService
// the name of the run function
#define SERV_3_RUN RunTemplateService
// How big should this services Queue be?
